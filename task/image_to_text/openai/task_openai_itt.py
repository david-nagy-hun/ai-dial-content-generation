...
def start() -> None:
    ...
    txt_content = TxtContent("What is in this image?")
    img_url = ImgUrl(f"data:image/png;base64,{base64_image}")
    img_content = ImgContent(img_url)
    message = ContentedMessage(Role.USER, [txt_content, img_content])
